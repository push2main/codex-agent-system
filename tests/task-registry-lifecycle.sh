...
jq -e '
  ...
  .tasks[0].execution.provider == "claude" and
  .tasks[0].execution.lane == "lane-1" and
  .tasks[0].execution.lease_state == "claimed" and
  (.tasks[0].execution.lease_claimed_at | type == "string") and
  .tasks[0].execution.result == "RUNNING" and
  .tasks[0].execution.attempt == 1 and
  ((.tasks[0].history | last).lane == "lane-1") and
...
jq -e '
  ...
  .tasks[0].execution.lease_state == "released" and
  (.tasks[0].execution.lease_released_at | type == "string") and
...
jq -e '
  ...
  .tasks[0].execution.lane == "lane-2" and
  .tasks[0].execution.lease_state == "released" and
