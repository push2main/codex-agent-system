...
touch -t 202603250513 "$TEST_ROOT/codex-learning/metrics.json"
touch -t 202603250510 "$TEST_ROOT/codex-memory/tasks.json"
touch -t 202603250512 "$EXTERNAL_PROJECT_ROOT/.codex-agent/tasks.json"
...
echo "prepare automation context cross-project approved local-scope test passed"
