...
expected_summary = "Self-improve is intentionally paused by file; no new improvement tasks will be generated until the pause gate is removed. Pause file detected at 2026-03-28T10:29:42Z."
...
assert self_improve["pause"]["reason"] == "paused_by_file", self_improve
assert self_improve["operator_signal"]["kind"] == "self_improve_paused", self_improve
assert self_improve["operator_signal"]["title"] == "Self-improve is paused", self_improve
...
assert summary["pause"]["active"] is True, summary
assert summary["operator_signal"]["kind"] == "self_improve_paused", summary
assert summary["operator_signal"]["summary"] == expected_summary, summary

assert overview["source"] == "self_improve", overview
assert overview["kind"] == "self_improve_paused", overview
...
echo "dashboard self-improve paused signal test passed"
