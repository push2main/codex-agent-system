...
cat >"$TEST_ROOT/codex-memory/tasks.json" <<'EOF'
{
  "tasks": [
    {
      "id": "task-timeout-legacy-success",
      ...
      "execution_context": {
        "run_id": "run-timeout-legacy-success-001",
        "result": "SUCCESS",
        "attempts": 1,
...
{"timestamp":"2026-03-24T02:05:00Z","project":"codex-agent-system","task":"Cut queue timeout churn before retries burn worker capacity","provider":"codex","result":"FAILURE","attempts":1,"score":0,"branch":"","pr_url":"","run_id":"queue-timeout-lane-1-20260324T020500Z","duration_seconds":300,"total_step_attempts":0,"failure_kind":"timeout"}
{"timestamp":"2026-03-24T02:06:00Z","project":"codex-agent-system","task":"Cut queue timeout churn before retries burn worker capacity","provider":"codex","result":"SUCCESS","attempts":1,"score":8,"branch":"","pr_url":"","run_id":"run-timeout-legacy-success-001","duration_seconds":240,"total_step_attempts":1}
EOF
...
echo "strategy legacy timeout success reconciliation test passed"
