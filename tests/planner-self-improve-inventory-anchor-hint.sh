...
cat >"$TEST_ROOT/codex-memory/self-improve-inventory-improve-first-pass-success-rate.md" <<'EOF'
...
- Narrow branch: `inventory_only_step(implementation_step)`
EOF
...
echo "planner self-improve inventory anchor hint test passed"
