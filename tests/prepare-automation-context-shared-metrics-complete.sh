...
cat >"$TEST_ROOT/codex-learning/metrics.json" <<'EOF'
{
  ...
  "approved_backlog": 0,
  "approved_tasks_cross_project": 1,
  "queued_tasks": 0,
  "running_tasks": 0,
...
touch -t 202603250512 "$TEST_ROOT/codex-learning/metrics.json"
touch -t 202603250510 "$TEST_ROOT/codex-memory/tasks.json"
touch -t 202603250511 "$EXTERNAL_PROJECT_ROOT/.codex-agent/tasks.json"
...
echo "prepare automation context shared metrics complete test passed"
