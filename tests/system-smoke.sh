...
bash "$ROOT_DIR/tests/dashboard-api-task-registry-pressure-metrics-alignment.sh"
bash "$ROOT_DIR/tests/task-registry-pressure-summary.sh"
...
bash "$ROOT_DIR/tests/strategy-saturation-rescue-fallback-target.sh"
