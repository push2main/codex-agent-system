...
- **planning**: 0/1 success | Rule: In `agents/planner.sh`, reject any task title or step prompt over 24 words or containing 3 or more c
...
All-time success rate: 0.14. Recent (last 50): 0.04. Q4 (last 132): 0.04. First-pass: 1.0. Timeout rate: 0.35.
Focus: reduce timeout rate (0.35 of failures), prevent zero-step-attempt timeouts via simpler plans.
Trend: NOT IMPROVING (-2.3pp first-half vs second-half success rate).
