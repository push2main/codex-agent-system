#!/bin/bash
# Generate a 32x32 solid blue RGBA PNG using node and write to target
node -e '
...
require("fs").writeFileSync("/Users/benediktpoller/code/push2main.io/superheld/desktop/src/main/resources/tray-icon.png", png);
console.log("Done, wrote " + png.length + " bytes");
'
